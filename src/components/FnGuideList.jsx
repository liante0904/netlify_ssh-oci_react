...
function FnGuideList() {
  ...
  useEffect(() => { if (!selectedDate || !chipsRef.current) return; const chip = chipsRef.current.querySelector(`[data-date-chip="${selectedDate}"]`); chip?.scrollIntoView({ behavior: 'smooth', block: 'nearest', inline: 'center' }); }, [dates, selectedDate]);
